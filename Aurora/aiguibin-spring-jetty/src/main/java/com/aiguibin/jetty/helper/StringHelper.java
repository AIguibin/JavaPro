...
public class StringHelper {
     ...
     * @return 编码后的字符串
     * @deprecated 工具方法移动到 {@link TypeHelper#byteArray2Base64(byte[])} ，请使用TypeUtis中的方法替代；本方法可能在未来版本中被移除。
     */
    public static String byte2Base64String(byte[] value) {
        return TypeHelper.byteArray2Base64(value);
    }
     ...
     * @return 解码后的字节数据
     * @deprecated 工具方法移动到 {@link TypeHelper#base642ByteArray(String)} ，请使用TypeUtis中的方法替代；本方法可能在未来版本中被移除。
     */
    public static byte[] Base64String2Byte(String base64Str) {
        return TypeHelper.base642ByteArray(base64Str);
    }
     ...
     * @param b 字节
     * @return 十六进制编码的字符串
     * @deprecated 工具方法移动到 {@link TypeHelper#byte2HexString(byte)} ，请使用TypeUtis中的方法替代；本方法可能在未来版本中被移除。
     */
    public static String byte2HexString(byte b) {
        return TypeHelper.byte2HexString(b);
    }
     ...
     * @deprecated 工具方法移动到 {@link TypeHelper#hexString2ByteArray(String)} ，请使用TypeUtis中的方法替代；本方法可能在未来版本中被移除。
     */
    public static byte[] hexString2Byte(String input) throws NumberFormatException {
        return TypeHelper.hexString2ByteArray(input);
    }
     ...
     * @deprecated 工具方法移动到 {@link TypeHelper#byteArray2HexString(byte[])} ，请使用TypeUtis中的方法替代；本方法可能在未来版本中被移除。
     */
    public static String byte2HexString(byte[] bs) {
        return TypeHelper.byteArray2HexString(bs);
    }
     ...
     * @return boolean值
     * @deprecated 工具方法移动到 {@link TypeHelper#string2Boolean(String, boolean)} ，请使用TypeUtis中的方法替代；本方法可能在未来版本中被移除。
     */
    public static boolean string2Boolean(String str, boolean defaultValue) {
        return TypeHelper.string2Boolean(str, defaultValue);
    }
     ...
     * @return int值
     * @deprecated 工具方法移动到 {@link TypeHelper#string2Int(String, TypeHelper.Radix, int)} ，请使用TypeUtis中的方法替代；本方法可能在未来版本中被移除。
     */
    public static int string2Int(String str, TypeHelper.Radix radix, int defaultValue) {
        return TypeHelper.string2Int(str, radix, defaultValue);
    }
     ...
     * @return long值
     * @deprecated 工具方法移动到 {@link TypeHelper#string2Long(String, TypeHelper.Radix, long)} ，请使用TypeUtis中的方法替代；本方法可能在未来版本中被移除。
     */
    public static long string2Long(String str, TypeHelper.Radix radix, long defaultValue) {
        return TypeHelper.string2Long(str, radix, defaultValue);
    }
     ...
     * @return float值
     * @deprecated 工具方法移动到 {@link TypeHelper#string2Float(String, float)} ，请使用TypeUtis中的方法替代；本方法可能在未来版本中被移除。
     */
    public static float string2Float(String str, float defaultValue) {
        return TypeHelper.string2Float(str, defaultValue);
    }
     ...
     * @return double值
     * @deprecated 工具方法移动到 {@link TypeHelper#string2Double(String, double)} ，请使用TypeUtis中的方法替代；本方法可能在未来版本中被移除。
     */
    public static double string2Double(String str, double defaultValue) {
        return TypeHelper.string2Double(str, defaultValue);
    }
     ...
     * @param defaultValue 默认值
     * @return 空间大小
     * @deprecated 工具方法移动到 {@link TypeHelper#string2Size(String, long)} ，请使用TypeUtis中的方法替代；本方法可能在未来版本中被移除。
     */
    public static long string2Size(String size, long defaultValue) {
        return TypeHelper.string2Size(size, defaultValue);
    }
     ...
     * @param defaultValue 默认值
     * @return 时间周期，单位毫秒
     * @deprecated 工具方法移动到 {@link TypeHelper#string2TimePeriod(String, long)} ，请使用TypeUtis中的方法替代；本方法可能在未来版本中被移除。
     */
    public static long stirng2TimePeriod(String timePeriod, long defaultValue) {
        return TypeHelper.string2TimePeriod(timePeriod, defaultValue);
    }
